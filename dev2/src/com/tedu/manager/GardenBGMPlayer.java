...
//	}
	...
	public GardenBGMPlayer(String srcPath) {
	 ...
	 * @return	返回当前对象
	 */
	public GardenBGMPlayer setLoop(boolean isLoop) {
		this.isLoop = isLoop;
		return this;
	}
	 ...
	 * @return	返回当前对象
	 */
	public GardenBGMPlayer setVolumn(float newVolumn) {
